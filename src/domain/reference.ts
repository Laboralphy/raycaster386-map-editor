...
export const PHYS_TABLE: readonly PhysEntry[] = Object.freeze([
    { id: 0, label: 'Walkable', desc: 'You can walk on this type of block', tiles: 'fc', offset: false },
    { id: 1, label: 'Solid', desc: 'You cannot walk on this type of block : this is a plain solid wall', tiles: 'news', offset: false },
    { id: 2, label: 'Door up', desc: 'This is a door that slides up when opened', tiles: 'fcnews', offset: false },
    { id: 3, label: 'Curtain up', desc: 'This is a curtain that slides up when opened', tiles: 'fcnews', offset: false },
    { id: 4, label: 'Door down', desc: 'This is a door that slides down when opened', tiles: 'fcnews', offset: false },
    { id: 5, label: 'Curtain down', desc: 'This is a curtain that slides down when opened', tiles: 'fcnews', offset: false },
    { id: 6, label: 'Door right', desc: 'This is a door that slides to the right when opened', tiles: 'fcnews', offset: false },
    { id: 7, label: 'Door left', desc: 'This is a door that slides to the left when opened', tiles: 'fcnews', offset: false },
    { id: 8, label: 'Door double', desc: 'This is a double panel door', tiles: 'fcnews', offset: false },
    { id: 9, label: 'Secret block', desc: 'This is a secret block (they work in pair)', tiles: 'fcnews', offset: false },
    {
        id: 10,
    ...
    { id: 11, label: 'Invisible block', desc: 'This is an invisible block : It is not walkable', tiles: 'fc', offset: false },
    { id: 12, label: 'Offset block', desc: 'This block is like a solid block, with an offset', tiles: 'fcnews', offset: true },
]);
